...
export const I18N = {
  en: {
    ...
    dashSubtitle: 'Track your progress and pick up where you left off.',
    correct: 'correct',
    active: 'active',
    allTime: 'all time',
    masteryByTopic: 'By topic',
    topics: 'topics',
    colTopic: 'Topic',
    colLearned: 'Learned',
    ...
    dashSubtitle: 'Seuraa edistymistäsi ja jatka siitä mihin jäit.',
    correct: 'oikein',
    active: 'aktiivinen',
    allTime: 'kaikkien aikojen',
    masteryByTopic: 'Aiheittain',
    topics: 'aihetta',
    colTopic: 'Aihe',
    colLearned: 'Opittu',
    colProgress: 'Edistyminen',
    colPct: '%',
